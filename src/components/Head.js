...
const SeoMeta = () => (
  <Helmet defaultTitle="Ninjality" titleTemplate="%s - Ninjality">
    <html lang="en" />
    ...
    <link
      ...
      sizes="180x180"
      href="/favicons/apple-touch-icon.png?v=ngGzKMween"
    />
    <link
      rel="icon"
      type="image/png"
      href="/favicons/favicon-32x32.png?v=ngGzKMween"
      sizes="32x32"
    />
    <link
      rel="icon"
      type="image/png"
      href="/favicons/favicon-16x16.png?v=ngGzKMween"
      sizes="16x16"
    />
    ...
    <meta
      ...
      content="/favicons/browserconfig.xml?v=ngGzKMween"
    />
